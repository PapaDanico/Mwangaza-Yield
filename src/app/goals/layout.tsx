...
export const metadata: Metadata = {
  title: 'Income Goals from Government Bonds — Mwangaza Yield',
  description:
    'Work backwards from the monthly income you want to the bonds and the capital that would produce it.',
};
