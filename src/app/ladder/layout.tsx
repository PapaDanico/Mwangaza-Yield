...
export const metadata: Metadata = {
  title: 'Build a Bond Ladder — Mwangaza Yield',
  description:
    'Spread capital across maturities so something is always coming due. Coupon dates, reinvestment and net yield, worked out for you.',
};
