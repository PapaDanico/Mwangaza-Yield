...
export default function GoalsClient() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* The heading and intro that used to open this row are now
          server-rendered by page.tsx via ToolShell, so a crawler receives
          them. With only the controls left, the row justifies to the end
          rather than spreading around a heading that is no longer here. */}
      <div className="no-print flex flex-wrap items-end justify-end gap-3">
