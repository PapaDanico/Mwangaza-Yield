...
export const metadata: Metadata = {
  title: 'Selling a Bond Before Maturity — Mwangaza Yield',
  description:
    'What you would receive if you sold today, what it costs you against holding, and the break-even price you would need.',
};
