...
export const metadata: Metadata = {
  title: 'Auction Results and Demand — Mwangaza Yield',
  description:
    'What every Treasury bond auction actually cleared at, how contested it was, and how far bidders were from the rate the government would pay.',
};
