...
export const metadata: Metadata = {
  title: 'Your Portfolio and DhowCSD Import — Mwangaza Yield',
  description:
    'Import a DhowCSD holdings export and see what your Kenyan government bonds are worth and earning. Parsed in your browser; never uploaded.',
};
