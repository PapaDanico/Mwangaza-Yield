...
export default function MarketPulse() {
  ...
  * earlier layout and had drifted badly — this one by 392px on a phone.
  ...
  * breakpoint swaps into a different height. */
  if (!buckets.some((b) => b.median !== null)) return <Reserve height={472} className="min-h-[612px] sm:min-h-[472px]" />;
