...
export const metadata: Metadata = {
  title: 'Auction and Maturity Alerts — Mwangaza Yield',
  description:
    'Be told when a Treasury bond auction opens and when your holdings pay a coupon or mature. Runs on your device; nothing leaves it.',
};
