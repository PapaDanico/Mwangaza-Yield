    ...
    <div className="space-y-5">
      <div>
        <h1 className="flex items-center gap-2 text-2xl font-bold text-ink">
          <ArrowRightLeft size={22} className="text-gold-600" /> Should you sell?
        </h1>
        <p className="mt-1 max-w-[64ch] text-sm leading-relaxed text-ink-muted">
          ...
          whether to do it. Type the figures from your quote and we will check the arithmetic,
          then work out the one number that decides it: what your next investment has to earn
          for the swap to leave you no worse off.
        </p>
      </div>
