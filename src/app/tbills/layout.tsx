...
export const metadata: Metadata = {
  title: 'Treasury Bills: 91, 182 and 364-Day Rates — Mwangaza Yield',
  description:
    'Current CBK Treasury bill rates, gross and net of the 15% withholding tax, with the minimum you need to take part.',
};
